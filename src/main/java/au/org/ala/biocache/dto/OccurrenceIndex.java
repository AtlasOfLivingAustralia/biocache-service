...
public class OccurrenceIndex {
    ...
    @Field("raw_catalogueNumber") String raw_catalogNumber;
    ...
    @Field("genus_id") String genusGuid;
    @Field("species") String species;
    @Field("species_id") String speciesGuid;
    @Field("subspecies") String subspecies;
    @Field("subspecies_id") String subspeciesGuid;
