 ...
 */
public class SpatialSearchRequestDTO {
    ...
    @Parameter(name="fl", description = "Fields to return. Optional")
    ...
    @Parameter(name="flimit", description = "The limit for the number of facets to return)")
