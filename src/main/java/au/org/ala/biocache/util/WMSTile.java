...
public class WMSTile {
    ...
    public WMSTile(String query, String colourmode, ArrayList<float[]> points, ArrayList<int[]> counts, List<Integer> colours, double[] bbox) {
        this.query = query;
    ...
    public boolean isCacheable(long maxSize) {
        return size < maxSize;
    }
